...
public class TC3_MotorCycle_Silver {
	...
	public static void main(String[] args) throws Exception {
		...
		WebElement cy =driver.findElement(By.id("cylindercapacity"));
		cy.sendKeys("1000");
		cy.click();
		WebElement ep =driver.findElement(By.id("engineperformance"));
		ep.sendKeys("1000");
		ep.click();
	    ...
	    String expectedPrice="247.00",actualPrice,expectedClaim="No",actualClaim,expectedDisscount="No",actualDisscount,expecteddWorldwideCover="No",actualWorldwideCover;
