...
public class TC3_MotorCycle_Platinum {
	...
	public static void main(String[] args) throws Exception {
	    ...
	    String expectedPrice="1,702.00",actualPrice,expectedClaim="Submit",actualClaim,expectedDisscount="5",actualDisscount,expecteddWorldwideCover="Limited",actualWorldwideCover;
        ...
        driver.findElement(By.id("email")).sendKeys("prathameshSahare396@gmail.com");
